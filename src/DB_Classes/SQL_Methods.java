...
public class SQL_Methods {
    ...
    final public static String SMJ_Client = "CREATE TABLE SMJ_Client\n(\n" +
    ...
    final public static String SMJ_Car = "CREATE TABLE SMJ_Car\n(\n" +
    ...
    final public static String SMJ_QuoteCar = "CREATE TABLE SMJ_QuoteCar\n(\n" +
    ...
    final public static String SMJ_AutoPolicy = "CREATE TABLE SMJ_AutoPolicy\n(\n" +
    ...
    final public static String SMJ_Property = "CREATE TABLE SMJ_Property\n(\n" +
    ...
    final public static String SMJ_QuoteProperty = "CREATE TABLE SMJ_QuoteProperty\n(\n\n" +
            "    quote_number    NUMBER(8) NOT NULL,\n" +
    ...
    final public static String SMJ_PropertyPolicy = "CREATE TABLE SMJ_PropertyPolicy\n(\n" +
            "    policy_number   NUMBER(8) NOT NULL,\n" +
            "    quote_number    NUMBER(8),\n" +
            "    premium         NUMBER(8, 2),\n" +
            "    effective_date  DATE,\n" +
    ...
    final public static String insValClient = "INSERT ALL\n" +
    ...
    final public static String insValCar = "INSERT ALL\n" +
    ...
    final public static String insValQuoteCar = "INSERT ALL\n" +
    ...
    final public static String insValAutoPolicy = "INSERT ALL\n" +
    ...
    final public static String insValProperty = "INSERT ALL\n" +
    ...
    final public static String insValQuoteProperty = "INSERT ALL\n" +
    ...
    final public static String insValPropertyPolicy = "INSERT ALL\n" +
